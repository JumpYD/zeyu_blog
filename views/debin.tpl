...
<form action="/html/debin.php" method="post" name="params_form" id="params_form">
	<input type="text" id='page' name='page' value="<{$query_info['page']}>"/>
	<input type="text" id='limit' name='limit' value="<{$query_info['limit']}>"/>
	<input type="text" id='tags' name='tags' value="<{$query_info['tags']}>"/>
	<input type="text" id='category' name='category' value="<{$query_info['category']}>"/>
</form>
<script>
